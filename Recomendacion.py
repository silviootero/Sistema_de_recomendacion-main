...
def main():
    ...
    st.text("el sistema actualizara cada minimo cambio , primero rellene toda la info antes de marcar la opcion de ingresar , "
    ...
    st.text("Ingrese su nombre de usuario:")
    ...
    st.text("juegos que jugastes con la poblacion")
    ...
    st.text("puntuaciones de poblacion de juegos que no ha jugado el usuario")
    ...
    st.dataframe(eeeee)
    st.title("recomendacion ahora si si")
